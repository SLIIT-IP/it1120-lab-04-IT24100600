...
public class IT24100600Lab4Q2
{
	public static void main(String[] args)
	{
		...
		double exMARKS = keyboard.nextDouble();
			...
			//else {System.out.println("Invalod input exam marks. Terminating program.");}
		...
		double perexMARKS = keyboard.nextDouble();
			...
			//else {System.out.println("Invalid input for lab exam percentage. Terminating program.");}
		...
		double perlbMARKS = keyboard.nextDouble();
			...
			//else {System.out.println("Invalid input for lab lab percentage. Terminating program.");}
